if (typeof globalPopup === "undefined") {let globalPopup = null;}
if (typeof globalPopupInner === "undefined") {let globalPopupInner = null;}

if (typeof activePromptTextarea === "undefined") {const activePromptTextarea = {};}
...
function setupExtraNetworks() {
  console.log("SD Lora Tagger: Hello!");
...
if (typeof re_extranet === "undefined") {const re_extranet = /<([^:]+:[^:]+):[\d\.]+>/;}
if (typeof re_extranet_g === "undefined") {const re_extranet_g = /\s+<([^:]+:[^:]+):[\d\.]+>/g;}
